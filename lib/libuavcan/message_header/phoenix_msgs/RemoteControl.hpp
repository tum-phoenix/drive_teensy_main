 ...
 *
 * Source file: /lnk/phoenix/drive_teensy_main/lib/phoenix_msgs/5000.RemoteControl.uavcan
 */

#ifndef PHOENIX_MSGS_REMOTECONTROL_HPP_INCLUDED
#define PHOENIX_MSGS_REMOTECONTROL_HPP_INCLUDED
...
struct UAVCAN_EXPORT RemoteControl_
{
    ...
    {
        return "phoenix_msgs.RemoteControl";
    }
...
{
    ::uavcan::DataTypeSignature signature(0x7DCC6D70D8F6FB92ULL);
...
const ::uavcan::DefaultDataTypeRegistrator< ::phoenix_msgs::RemoteControl > _uavcan_gdtr_registrator_RemoteControl;
...
template <>
class UAVCAN_EXPORT YamlStreamer< ::phoenix_msgs::RemoteControl >
{
public:
    template <typename Stream>
    static void stream(Stream& s, ::phoenix_msgs::RemoteControl::ParameterType obj, const int level);
};

template <typename Stream>
void YamlStreamer< ::phoenix_msgs::RemoteControl >::stream(Stream& s, ::phoenix_msgs::RemoteControl::ParameterType obj, const int level)
{
    (void)s;
    (void)obj;
    (void)level;
    ...
    s << "drive_mode: ";
    YamlStreamer< ::phoenix_msgs::RemoteControl::FieldTypes::drive_mode >::stream(s, obj.drive_mode, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "aux_mode: ";
    YamlStreamer< ::phoenix_msgs::RemoteControl::FieldTypes::aux_mode >::stream(s, obj.aux_mode, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "velocity: ";
    YamlStreamer< ::phoenix_msgs::RemoteControl::FieldTypes::velocity >::stream(s, obj.velocity, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "steer_rear: ";
    YamlStreamer< ::phoenix_msgs::RemoteControl::FieldTypes::steer_rear >::stream(s, obj.steer_rear, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "steer_front: ";
    YamlStreamer< ::phoenix_msgs::RemoteControl::FieldTypes::steer_front >::stream(s, obj.steer_front, level + 1);
}
...
template <typename Stream>
inline Stream& operator<<(Stream& s, ::phoenix_msgs::RemoteControl::ParameterType obj)
{
    ::uavcan::YamlStreamer< ::phoenix_msgs::RemoteControl >::stream(s, obj, 0);
    return s;
}

} // Namespace phoenix_msgs

#endif // PHOENIX_MSGS_REMOTECONTROL_HPP_INCLUDED