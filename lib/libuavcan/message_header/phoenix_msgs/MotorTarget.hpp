 ...
 *
 * Source file: /lnk/phoenix/drive_teensy_main/lib/phoenix_msgs/5001.MotorTarget.uavcan
 */

#ifndef PHOENIX_MSGS_MOTORTARGET_HPP_INCLUDED
#define PHOENIX_MSGS_MOTORTARGET_HPP_INCLUDED
...
struct UAVCAN_EXPORT MotorTarget_
{
    ...
    {
        return "phoenix_msgs.MotorTarget";
    }
...
{
    ::uavcan::DataTypeSignature signature(0x55AF04E9C709CB9AULL);
...
const ::uavcan::DefaultDataTypeRegistrator< ::phoenix_msgs::MotorTarget > _uavcan_gdtr_registrator_MotorTarget;
...
template <>
class UAVCAN_EXPORT YamlStreamer< ::phoenix_msgs::MotorTarget >
{
public:
    template <typename Stream>
    static void stream(Stream& s, ::phoenix_msgs::MotorTarget::ParameterType obj, const int level);
};

template <typename Stream>
void YamlStreamer< ::phoenix_msgs::MotorTarget >::stream(Stream& s, ::phoenix_msgs::MotorTarget::ParameterType obj, const int level)
{
    (void)s;
    (void)obj;
    (void)level;
    ...
    s << "servo_front_left: ";
    YamlStreamer< ::phoenix_msgs::MotorTarget::FieldTypes::servo_front_left >::stream(s, obj.servo_front_left, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "servo_front_right: ";
    YamlStreamer< ::phoenix_msgs::MotorTarget::FieldTypes::servo_front_right >::stream(s, obj.servo_front_right, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "servo_rear_left: ";
    YamlStreamer< ::phoenix_msgs::MotorTarget::FieldTypes::servo_rear_left >::stream(s, obj.servo_rear_left, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "servo_rear_right: ";
    YamlStreamer< ::phoenix_msgs::MotorTarget::FieldTypes::servo_rear_right >::stream(s, obj.servo_rear_right, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    YamlStreamer< ::phoenix_msgs::MotorTarget::FieldTypes::current_front_left >::stream(s, obj.current_front_left, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    YamlStreamer< ::phoenix_msgs::MotorTarget::FieldTypes::current_front_right >::stream(s, obj.current_front_right, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "current_rear_left: ";
    YamlStreamer< ::phoenix_msgs::MotorTarget::FieldTypes::current_rear_left >::stream(s, obj.current_rear_left, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    YamlStreamer< ::phoenix_msgs::MotorTarget::FieldTypes::current_rear_right >::stream(s, obj.current_rear_right, level + 1);
}
...
template <typename Stream>
inline Stream& operator<<(Stream& s, ::phoenix_msgs::MotorTarget::ParameterType obj)
{
    ::uavcan::YamlStreamer< ::phoenix_msgs::MotorTarget >::stream(s, obj, 0);
    return s;
}

} // Namespace phoenix_msgs

#endif // PHOENIX_MSGS_MOTORTARGET_HPP_INCLUDED