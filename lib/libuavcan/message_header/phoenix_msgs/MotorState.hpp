 ...
 *
 * Source file: /lnk/phoenix/drive_teensy_main/lib/phoenix_msgs/5002.MotorState.uavcan
 */

#ifndef PHOENIX_MSGS_MOTORSTATE_HPP_INCLUDED
#define PHOENIX_MSGS_MOTORSTATE_HPP_INCLUDED
...
/******************************* Source text **********************************
uint8 POS_UNKNOWN = 0
uint8 POS_FRONT_LEFT = 1
uint8 POS_FRONT_RIGHT = 2
uint8 POS_REAR_LEFT = 3
uint8 POS_REAR_RIGHT = 4
uint8 position
...
struct UAVCAN_EXPORT MotorState_
{
    ...
    {
        typedef ::uavcan::IntegerSpec< 8, ::uavcan::SignednessUnsigned, ::uavcan::CastModeSaturate > POS_UNKNOWN;
    ...
    // Constants
    static const typename ::uavcan::StorageType< typename ConstantTypes::POS_UNKNOWN >::Type POS_UNKNOWN; // 0
    static const typename ::uavcan::StorageType< typename ConstantTypes::POS_FRONT_LEFT >::Type POS_FRONT_LEFT; // 1
    static const typename ::uavcan::StorageType< typename ConstantTypes::POS_FRONT_RIGHT >::Type POS_FRONT_RIGHT; // 2
    static const typename ::uavcan::StorageType< typename ConstantTypes::POS_REAR_LEFT >::Type POS_REAR_LEFT; // 3
    static const typename ::uavcan::StorageType< typename ConstantTypes::POS_REAR_RIGHT >::Type POS_REAR_RIGHT; // 4
    ...
    {
        return "phoenix_msgs.MotorState";
    }
...
{
    ::uavcan::DataTypeSignature signature(0xEDAE14B11E3FC557ULL);
...
const ::uavcan::DefaultDataTypeRegistrator< ::phoenix_msgs::MotorState > _uavcan_gdtr_registrator_MotorState;
...
template <>
class UAVCAN_EXPORT YamlStreamer< ::phoenix_msgs::MotorState >
{
public:
    template <typename Stream>
    static void stream(Stream& s, ::phoenix_msgs::MotorState::ParameterType obj, const int level);
};

template <typename Stream>
void YamlStreamer< ::phoenix_msgs::MotorState >::stream(Stream& s, ::phoenix_msgs::MotorState::ParameterType obj, const int level)
{
    (void)s;
    (void)obj;
    (void)level;
    ...
    s << "position: ";
    YamlStreamer< ::phoenix_msgs::MotorState::FieldTypes::position >::stream(s, obj.position, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "temp_fet: ";
    YamlStreamer< ::phoenix_msgs::MotorState::FieldTypes::temp_fet >::stream(s, obj.temp_fet, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "motor_current: ";
    YamlStreamer< ::phoenix_msgs::MotorState::FieldTypes::motor_current >::stream(s, obj.motor_current, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "input_current: ";
    YamlStreamer< ::phoenix_msgs::MotorState::FieldTypes::input_current >::stream(s, obj.input_current, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "input_voltage: ";
    YamlStreamer< ::phoenix_msgs::MotorState::FieldTypes::input_voltage >::stream(s, obj.input_voltage, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "rpm: ";
    YamlStreamer< ::phoenix_msgs::MotorState::FieldTypes::rpm >::stream(s, obj.rpm, level + 1);
    s << '\n';
    for (int pos = 0; pos < level; pos++)
    {
        s << "  ";
    ...
    s << "fault_code: ";
    YamlStreamer< ::phoenix_msgs::MotorState::FieldTypes::fault_code >::stream(s, obj.fault_code, level + 1);
}
...
template <typename Stream>
inline Stream& operator<<(Stream& s, ::phoenix_msgs::MotorState::ParameterType obj)
{
    ::uavcan::YamlStreamer< ::phoenix_msgs::MotorState >::stream(s, obj, 0);
    return s;
}

} // Namespace phoenix_msgs

#endif // PHOENIX_MSGS_MOTORSTATE_HPP_INCLUDED